...
public class CompanyDaoTestSuite {
    ...
    public void testSearchEmployeeByLastName() {
        ...
        List<Employee> searchResult = employeeDao.searchEmployeeBySurname("Kovalsky");
        //Then
    ...
    @Test
    public void testSearchCompanyBy3FirstChars() {
        //Given
        Employee johnSmith = new Employee("John", "Smith");
        Employee stephanieClarckson = new Employee("Stephanie", "Clarckson");
        Employee lindaKovalsky = new Employee("Linda", "Kovalsky");
        ...
        List<Company> searchResult = companyDao.searchCompanyBy3FirstChars("Sof");
        //Then
        Assert.assertEquals(1, searchResult.size());
